            ...
            <div class="container">
                <div class="contact_row">
                    ...
                    <form class="contact_form" id="contactForm" method="post" action="">
                        <input type="hidden" name="csrfmiddlewaretoken" value="WnXA2zTNsNQ0cY8mt4Z7OJIyOy161QIbX70MVcyuYtZooRtgNQTkbTu9UEmsUh5E">
...
.contacts .contact_form .form_group input, .contacts .contact_form .form_group textarea {
    padding: 16px;
    font-size: 16px;
    font-weight: 400;
    width: 100%;
}
.contacts .contact_form .form_group input, .contacts .contact_form .form_group textarea, .contacts .contact_form .form_group button {
    border-radius: 32px;
    background: #20344a;
    border: 0;
    outline: 0;
