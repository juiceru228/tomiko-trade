                ...
                <div class="stage_block">
                    ...
                    <div class="btns_stage">
                        ...
                        <a href="https://wa.me/79244202432" target="_blank"><img loading="lazy"
                                src="../assets/cta_button1.svg" alt="whatsapp"></a>
                    </div>
...
.stage_work .save_discount::after {
    position: absolute;
    content: "";
    width: 96%;
    height: 130px;
...
.stage_work .save_discount p span {
    font-weight: 900;
    font-size: 32px;
}
